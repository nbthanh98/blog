---
title: 'Ngày 61 - Kubernetes & Đa môi trường'
images: ['/static/images/ogps/90daysofdevopsd59.png']
summary: 'Trong bài viết này, chúng ta sẽ xem cách Terraform có thể được sử dụng để tương tác với các tài nguyên được hỗ trợ bởi Kubernetes'
tags: ['devops', '90daysofdevops', 'containers']
date: '2023-06-01'
index: 61
chapter: 'Tuần 8'
---
...
![](/static/images/assets/Day61_IAC5.png)
...
Hẹn gặp lại các bạn vào [Ngày 62](https://vntechies.dev/courses/90-ngay-devops/ngay-62-testing-tools-alternatives)
